...
static void AskQuestion(TreeNode* current_node);
static void AnswerWrong(TreeNode* current_node);
static Answer GetAnswer(const char* string);
...
static AkinatorState DescriptionAkinator(Tree* tree)
{
    ...
    while(parent_stack->size > 1)
    {
        ...
        {
            printf("\t┃-> ");
            InsertText(stack_node->value, WINDOW_WIDTH - strlen("-> "));
            printf("┃\n");
        }
        else
        {
            printf("\t┃-> Not ");
            InsertText(stack_node->value, WINDOW_WIDTH - strlen("-> Not "));
            printf("┃\n");
        }
...
static void PrintCommon(Stack_t* parent_stack1, Stack_t* parent_stack2)
{
    ...
    while(parent_stack1->size > 1 && parent_stack2->size > 1)
    {
        ...
        {
            printf("\t┃-> ");
            InsertText(stack_node1->value, WINDOW_WIDTH - strlen("-> "));
            printf("┃\n");
        }
        ...
        {
            printf("\t┃-> Not ");
            InsertText(stack_node1->value, WINDOW_WIDTH - strlen("-> Not "));
            printf("┃\n");
        }
        else
        {
...
static Answer GetAnswer(const char* string)
{
    if(!strcmp(string, INPUT_RIGHT)) return ANSWER_YES;
    if(!strcmp(string, INPUT_WRONG)) return ANSWER_NO;
